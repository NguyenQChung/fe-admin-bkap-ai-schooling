...
export default function Badges() {
  return (
    <div>
      <PageMeta
        title="  Badges Dashboard | TailAdmin -   Admin Dashboard Template"
        description="This is   Badges Dashboard page for TailAdmin -   Tailwind CSS Admin Dashboard Template"
      />
