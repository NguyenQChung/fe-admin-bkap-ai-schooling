...
export default function Avatars() {
  return (
    <>
      <PageMeta
        title="  Avatars Dashboard | TailAdmin -   Admin Dashboard Template"
        description="This is   Avatars Dashboard page for TailAdmin -   Tailwind CSS Admin Dashboard Template"
      />
